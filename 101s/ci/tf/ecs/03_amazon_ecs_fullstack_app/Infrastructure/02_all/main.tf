...
data "aws_ecr_repository" "ecr_server" {
  name = "repo-server"
}

data "aws_ecr_repository" "ecr_client" {
  name = "repo-client"
}
...
module "ecs_taks_definition_server" {
  ...
  cpu                = 256
  memory             = "512"
  docker_repo        = data.aws_ecr_repository.ecr_server.repository_url
   # module.ecr_server.ecr_repository_url
...
module "ecs_taks_definition_client" {
  ...
  cpu                = 256
  memory             = "512"
  docker_repo        = data.aws_ecr_repository.ecr_client.repository_url
  # module.ecr_client.ecr_repository_url  
  region             = var.aws_region
