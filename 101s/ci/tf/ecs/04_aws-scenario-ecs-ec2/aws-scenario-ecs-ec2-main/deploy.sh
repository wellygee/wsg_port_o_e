...
# ecr_repository_url = "xxxxxxxxxxxxxx.dkr.ecr.eu-west-1.amazonaws.com/wg/app-ecs-serv-xxxxxxxx"
...
# docker tag wg/$1:latest ${REPOSITORY_URL}:latest
# docker tag wg/$1:latest ${REPOSITORY_URL}:${HASH}
